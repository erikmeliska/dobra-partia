...
export default class TypeBuilder {
    ...
    Receipt: ClassViewer<'Receipt', "qrCode" | "supplierName" | "supplierVatId" | "totalAmount" | "currency" | "issueDate" | "items">;
    
    ReceiptItem: ClassViewer<'ReceiptItem', "name" | "quantity" | "unitPrice" | "totalPrice" | "vatRate">;
    ...
    constructor() {
        ...
        this.Receipt = this.tb.classViewer("Receipt", [
          "qrCode","supplierName","supplierVatId","totalAmount","currency","issueDate","items",
        ]);
        
        this.ReceiptItem = this.tb.classViewer("ReceiptItem", [
          "name","quantity","unitPrice","totalPrice","vatRate",
        ]);
