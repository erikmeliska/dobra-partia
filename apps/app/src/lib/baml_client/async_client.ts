    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.ExtractReceipt(
          receiptImage,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.Receipt
            } catch (error) {
            ...
            receiptImage: Image,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.Receipt, types.Receipt>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractReceipt", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Receipt, types.Receipt>(
                  __raw__,
                  (a): partial_types.Receipt => a,
                  (a): types.Receipt => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
